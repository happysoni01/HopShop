...
const UploadProduct = () => {
  ...
  const handleRemoveCategory = async (index) => {
    const updatedCategories = data.category.filter((_, i) => i !== index);
    setData((preve) => ({
      ...preve,
  ...
  const handleRemoveSubCategory = async (index) => {
    const updatedSubCategories = data.subCategory.filter((_, i) => i !== index);
    setData((preve) => ({
      ...preve,
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                {data.image.map((img, index) => (
                  <div key={index} className="h-20 mt-1 w-20 min-w-20 bg-blue-50 border relative group">
                    <img
                      src={img}
                      alt={img}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {data.category.map((c, index) => (
                  <div key={c._id} className="text-sm flex items-center gap-1 bg-blue-50 mt-2">
                    <p>{c.name}</p>
